 ...
 * @Author:wangyp
 * @Description:  实现发邮件功能
 * @Date: Created in 8:41 2017/7/21
 */
public class SendMail {
    ...
    public static void main(String[] args) {
        ...
        sendmail.setUserName("13296538826@163.com");// 您的邮箱用户名
        sendmail.setPassWord("wang521314%");// 您的邮箱密码
        sendmail.setTo("2292046831@qq.com");// 接收者
        sendmail.setFrom("13296538826@163.com");// 发送者
        sendmail.setSubject("this" + Math.random());
        sendmail.setContent("this, welcome thank you! ,这是我发送的测试邮件，请放心！" + Math.random());
